    ...
    <div className="flex flex-wrap -mx-4">
      <div className="w-full px-4">
        <ul className="flex flex-wrap items-center mb-16">
          ...
          <li><a className="text-sm font-medium text-red-500 hover:text-yellow-400" href="#">Savignon Blac</a></li>
        </ul>
      </div>
      ...
      <div className="w-full lg:w-1/2 px-4">
        <div className="max-w-md mb-6">
          ...
          <h2 className="mt-6 mb-4 text-5xl md:text-7xl lg:text-8xl font-heading font-medium"><span className='text-transparent bg-clip-text bg-gradient-to-br from-yellow-300 to-yellow-900'>UNI<span className='text-red-600'>Q</span></span> Spirits - Savignon Blanc</h2>
          <p className="flex items-center mb-6">
            <span className="mr-2 text-sm text-black font-medium">$</span>
            <span className="text-3xl text-red-500 font-medium">30.00</span>
          </p>
          <p className="text-lg text-gray-400">Premium craft Savignon Blanc wine is preservative free and 100% organic and certified delicious. </p>
        </div>
